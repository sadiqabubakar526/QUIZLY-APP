                  ...
                  <div className="radio">
                    <label>
                      <input type="radio" value={parseInt(this.state.key)} 
                        ...
                        {data.intermediate[this.state.index].options[0].answer}
                      </label>
                  </div>
                  <div className="radio">
                    <label>
                      <input type="radio" value={parseInt(this.state.key)+1} 
                                    ...
                                    onChange={this.handleOptionChange} />
                      {data.intermediate[this.state.index].options[1].answer}
                    </label>
                  </div>
                  <div className="radio">
                    <label>
                      <input type="radio" value={parseInt(this.state.key)+2} 
                                    ...
                                    onChange={this.handleOptionChange} />
                      {data.intermediate[this.state.index].options[2].answer}
                    </label>
                  </div>
                  <div className="radio">
                    <label>
                      <input type="radio" value={parseInt(this.state.key)+3}
                                    ...
                                    onChange={this.handleOptionChange} />
                      {data.intermediate[this.state.index].options[3].answer}
                    </label>
                  </div>
                </div>
